...
const ProductDetails = () => {
  ...
  const handleDecrease = (e) => {
    e.preventDefault(); // prevent dialog form submit if inside <form>
    if (buyQuantity > 1) {
  ...
  const handleBuy = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_server}/update-main-quantity/${id}`, {
        method: 'PATCH',
    ...
    const order = {
      ...
      buying_date: new Date().toISOString().split('T')[0], // YYYY-MM-DD
    };

    try {
      const res = await fetch(`${import.meta.env.VITE_server}/add-product-cart`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      if (data.insertedId) {
        ...
        toast.error('Add to cart unsuccessful');
      }
    } catch (err) {
      console.error(err);
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 my-20">
          {/* Image */}
          <div className="mt-10 flex justify-center items-center max-w-md mx-auto">
            <img
          ...
          <div className="p-5">
            ...
            <div className="py-5">
              ...
              <p className="font-bold">
                Category: <span className="badge badge-neutral">{productDetails.category}</span>
              </p>
            ...
            <dialog id="my_modal_3" className="modal">
              <div className="modal-box rounded-none max-w-md overflow-auto max-h-[80vh]">
                <form method="dialog">
                  <button
                    type="button"
                ...
                <div className="flex items-center my-4 gap-3">
                  ...
                  <span className="text-lg font-bold select-none">{buyQuantity}</span>
                  <button
                    type="button"
                    className="bg-gray-300 px-3 py-1 rounded hover:bg-gray-400"
                ...
                <div className="flex justify-end">
                  <button
                    type="button"
                    disabled={buyQuantity < productDetails.minimum_selling_quantity}
                    onClick={handleBuy}
            ...
            <button
              type="button"
              className="font-bold border text-lg uppercase w-30 h-10 text-white bg-[#FA6C48] hover:text-[#FA6C48] hover:bg-white mt-4 cursor-pointer rounded"
