  ...
  return (
    <div>
      ...
      <main className="container mx-auto my-10 px-4 min-h-screen">
        {/* Controls */}
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 bg-white shadow-sm p-4 rounded-lg">
          ...
          <div className="flex flex-wrap gap-3">
            <select
              ...
              className="border px-3 py-2 rounded-lg shadow-sm focus:ring-2 focus:ring-orange-400"
            >
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {filteredProducts.map(product => (
                  <tr
                    key={product._id}
                    className="hover:bg-orange-50 text-center transition-colors"
                  >
                    ...
                    <td className="p-2 border">
                      <Link to={`/update-product/${product._id}`}>
                        <button className="bg-orange-500 text-white px-3 py-1 rounded hover:bg-orange-600 transition-colors">
                          Update
                        </button>
                      </Link>
                    </td>
